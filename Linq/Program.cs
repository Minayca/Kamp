...
namespace Linq
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Any() listede o elemanın olup olmadığını söyler. Bool döndürür.
            //var result = products.Any(p => p.ProductName == "Acer Laptop");
            //Console.WriteLine(result);

            //Find() listedeki istediğimiz elemanı geri döndürür. Elemanın detay bilgisine gitmek için kullanılır.
            //var result = products.Find(p => p.ProductId == 3);
            //Console.WriteLine(result.ProductName);

            //FindAll() istediğimiz koşula göre liste döner.
